...
# stolen from https://github.com/ZwerOxotnik/factorio-example-mod/blob/99a0f38518ecc598167f3af27e37ef5d68013dfc/.scripts/upload.sh
...
# Upload the file
local UPLOAD_RESULT=$(curl -s -F "file=@build/${MOD_NAME}_${MOD_VERSION}.zip" "${UPLOAD_URL}")
